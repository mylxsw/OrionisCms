...
<form action="rbac/user/add" method="post" id="add_user_form" ajax="true" after="add_user_form_after">
	<admin:input name="userName" id="username" label="用户名"></admin:input>
    <admin:input name="password" type="password" label="密码" id="password"></admin:input>
    <admin:input name="email" label="邮箱" id="email"></admin:input>
    <admin:select name="roleId" label="所属角色" data="${roles }" id="roleid"></admin:select>
    <admin:buttonPanel>
